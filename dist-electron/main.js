...
var G = (e, a, i) => xn(e, typeof a != "symbol" ? a + "" : a, i);
...
class Sn {
  constructor(a, i, n) {
    G(this, "writeStream");
    G(this, "firstRow", !0);
    G(this, "batchSize", 5e3);
    G(this, "logger");
    G(this, "tempFilePath");
    G(this, "finalFilePath");
    var s;
    this.finalFilePath = `${a}/${i}.csv`, this.tempFilePath = `${a}/.${i}.csv`, this.writeStream = bn(this.tempFilePath, { flags: "a" }), this.logger = n, (s = this.logger) == null || s.log(`CSVWriter initialized with temp file: ${this.tempFilePath}`);
  }
  /**
   * Convert object to CSV line
   */
  objectToCSVLine(a) {
    return Object.values(a).map((i) => i == null ? '""' : typeof i == "object" ? `"${JSON.stringify(i).replace(/"/g, '""')}"` : typeof i == "string" ? `"${i.replace(/"/g, '""')}"` : typeof i == "boolean" ? i ? "true" : "false" : i).join(",") + `
`;
  }
  /**
  ...
  writeHeaders(a) {
    var i;
    if (this.firstRow) {
      const n = Object.keys(a).join(",") + `
`;
      this.writeStream.write(n), this.firstRow = !1, (i = this.logger) == null || i.log("Headers written to CSV file");
    }
  }
  /**
  ...
  async writeData(a) {
    ...
    return (i = this.logger) == null || i.log(`Writing ${a.length} records to CSV`), new Promise((n, s) => {
      var o;
      try {
        a.length > 0 && this.writeHeaders(a[0]);
        const t = new yn({
          objectMode: !0,
          transform: (u, r, p) => {
  ...
  async close() {
    ...
    return (a = this.logger) == null || a.log("Closing write stream"), new Promise((i, n) => {
      this.writeStream.end(), this.writeStream.on("finish", () => {
        gn(this.tempFilePath, this.finalFilePath, (s) => {
          var o, t;
          s ? ((o = this.logger) == null || o.error(`Error renaming file: ${s}`), n(s)) : ((t = this.logger) == null || t.log(`File renamed to ${this.finalFilePath}`), i());
        });
      }).on("error", (s) => {
        var o;
        (o = this.logger) == null || o.error(`Error closing write stream: ${s}`), n(s);
      });
    });
  }
}
...
), Ia = (({ hasOwnProperty: e }) => (a, i) => e.call(a, i))(Object.prototype), ss = H("RegExp"), ji = (e, a) => {
...
}, cs = (e, a) => e != null && Number.isFinite(e = +e) ? e : a, Ke = "abcdefghijklmnopqrstuvwxyz", $a = "0123456789", Si = {
  DIGIT: $a,
  ALPHA: Ke,
  ALPHA_DIGIT: Ke + Ke.toUpperCase() + $a
}, ps = (e = 16, a = Si.ALPHA_DIGIT) => {
  let i = "";
  const { length: n } = a;
  for (; e--; )
    i += a[Math.random() * n | 0];
...
var vs = ye, Ai = $.Stream, Ma = hs, bs = S;
function S() {
    ...
    Object.keys(a).forEach(function(f) {
      ...
      if (!(!x || !x.length)) {
        ...
        for (var g = 0; g < x.length; g++) {
          var w = x[g];
          if (p[w]) {
            var y = m.indexOf(a[p[w]].source), j = m.indexOf(v.source);
            if (p[w] !== "application/octet-stream" && (y > j || y === j && p[w].substr(0, 12) === "application/"))
              continue;
          }
          p[w] = f;
        }
...
var Va = qi, js = Pi, Bi = Ss;
function Ss(e, a, i, n) {
  var s = i.keyedList ? i.keyedList[i.index] : i.index;
  i.jobs[s] = Cs(a, s, e[s], function(o, t) {
    s in i.jobs && (delete i.jobs[s], o ? js(i) : i.results[s] = t, n(o, i.results));
  });
}
function Cs(e, a, i, n) {
  var s;
  ...
  function r(f, v, x) {
    ...
    if (f && !x && typeof f == "object") {
      if (l.endsWith(v, "{}"))
        ...
        return v = Hi(v), g.forEach(function(y, j) {
          !(l.isUndefined(y) || y === null) && a.append(
            // eslint-disable-next-line no-nested-ternary
            t === !0 ? Ka([v], j, o) : t === null ? v : v + "[]",
            u(y)
          );
        }), !1;
    }
...
}, Sa = typeof window < "u" && typeof document < "u", pa = typeof navigator == "object" && navigator || void 0, oo = Sa && (!pa || ["ReactNative", "NativeScript", "NS"].indexOf(pa.product) < 0), to = typeof WorkerGlobalScope < "u" && // eslint-disable-next-line no-undef
self instanceof WorkerGlobalScope && typeof self.importScripts == "function", ro = Sa && window.location.href || "http://localhost", co = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  hasBrowserEnv: Sa,
...
function Ro(e) {
  ...
  if (typeof n != "string" || !n || typeof i != "string" || (i = i.split(":", 1)[0], n = n.replace(/:\d*$/, ""), s = parseInt(s) || ko[i] || 0, !jo(n, s)))
    return "";
...
var So = Ro, Ta = { exports: {} }, je = { exports: {} }, Se = { exports: {} }, Ze, Ya;
function Co() {
  if (Ya) return Ze;
  Ya = 1;
...
var ni;
function Ao() {
  return ni || (ni = 1, typeof process > "u" || process.type === "renderer" || process.browser === !0 || process.__nwjs ? je.exports = To() : je.exports = Lo()), je.exports;
}
var fe, zo = function() {
  if (!fe) {
    try {
...
class si extends $.Transform {
  ...
  _transform(a, i, n) {
    const s = this[na], o = s.maxRate, t = this.readableHighWaterMark, c = s.timeWindow, d = 1e3 / c, u = o / d, r = s.minChunkSize !== !1 ? Math.max(s.minChunkSize, u * 0.01) : 0, p = (h, f) => {
      ...
      if (o) {
        const j = Date.now();
        (!s.ts || (y = j - s.ts) >= c) && (s.ts = j, w = u - s.bytes, s.bytes = w < 0 ? -w : 0, y = 0), w = u - s.bytes;
      }
      if (o) {
        if (w <= 0)
          return setTimeout(() => {
...
const lt = typeof process < "u" && l.kindOf(process) === "process", ut = (e) => new Promise((a, i) => {
  ...
  return ut(async function(n, s, o) {
    ...
    if (c) {
      ...
      c = (_, A, ae) => {
        k(_, A, (F, J, Ve) => {
          if (F)
            return ae(F);
          const K = l.isArray(J) ? J.map((D) => li(D)) : [li(J, Ve)];
    ...
    const w = Ca(a.baseURL, a.url), y = new URL(w, O.hasBrowserEnv ? O.origin : void 0), j = y.protocol || ci[0];
    if (j === "data:") {
      let k;
      if (p !== "GET")
        return ce(n, s, {
    ...
    !l.isUndefined(c) && (P.lookup = c), a.socketPath ? P.socketPath = a.socketPath : (P.hostname = y.hostname.startsWith("[") ? y.hostname.slice(1, -1) : y.hostname, P.port = y.port, nn(P, a.proxy, j + "//" + y.hostname + (y.port ? ":" + y.port : "") + P.path));
    let Re;
    ...
    if (P.agent = He ? a.httpsAgent : a.httpAgent, a.transport ? Re = a.transport : a.maxRedirects === 0 ? Re = He ? _a : wa : (a.maxRedirects && (P.maxRedirects = a.maxRedirects), a.beforeRedirect && (P.beforeRedirects.config = a.beforeRedirect), Re = He ? rt : tt), a.maxBodyLength > -1 ? P.maxBodyLength = a.maxBodyLength : P.maxBodyLength = 1 / 0, a.insecureHTTPParser && (P.insecureHTTPParser = a.insecureHTTPParser), f = Re.request(P, function(_) {
      ...
      if (u === "stream")
        ...
        F.on("data", function(q) {
          ...
          f.destroyed || s(b.from(q, null, a, J));
        }), F.on("end", function() {
          try {
...
const sn = (e) => {
  ...
  return new Promise(function(i, n) {
    ...
    }, o === void 0 && t.setContentType(null), "setRequestHeader" in x && l.forEach(t.toJSON(), function(j, E) {
      x.setRequestHeader(E, j);
...
const Et = async (e) => {
  ...
  try {
    ...
    u = u || "text";
    let j = await qe[l.findKey(qe, u) || "text"](w, e);
...
const fi = (e) => `- ${e}`, St = (e) => l.isFunction(e) || e === null || e === !1, rn = {
  getAdapter: (e) => {
    e = l.isArray(e) ? e : [e];
    const { length: a } = e;
    let i, n;
    ...
    for (let o = 0; o < a; o++) {
      i = e[o];
      let t;
      if (n = i, !St(i) && (n = fa[(t = String(i)).toLowerCase()], n === void 0))
...
async function Ut(e, a, i) {
  ...
  const n = `${e}_${Date.now()}`, s = new Sn(a, n, C);
  let o = 0, t = 1;
