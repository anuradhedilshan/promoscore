...
`;
  ...
  writeHeaders(a) {
    ...
    if (this.headers.length === 0) {
      this.headers = Object.keys(a);
      const n = this.headers.map((s) => this.escapeCSVValue(s)).join(",") + `
`;
      this.writeStream.write(n), (i = this.logger) == null || i.log("Headers written to CSV file");
    }
  }
  /**
  ...
  async writeData(a) {
    ...
    if (!(!Array.isArray(a) || a.length === 0))
      return (i = this.logger) == null || i.log(`Writing ${a.length} records to CSV`), new Promise((n, s) => {
        var o;
        try {
          this.writeHeaders(a[0]);
          const t = new yn({
            objectMode: !0,
            transform: (u, r, p) => {
              try {
                const m = this.objectToCSVLine(u);
                p(null, m);
              } catch (m) {
                p(m);
              }
          ...
          const d = () => {
            ...
            if (u.length === 0) {
              t.end(), n(), (p = this.logger) == null || p.log("All data written to CSV");
              return;
            }
            const r = u.every(
              (m) => t.write(m)
            );
            c += u.length, r ? setImmediate(d) : t.once("drain", d);
          };
          t.on("error", (u) => {
            var r;
            (r = this.logger) == null || r.error(`Transform stream error: ${u}`), s(u);
          }), d();
        } catch (t) {
  ...
  async close() {
    ...
    return (a = this.logger) == null || a.log("Closing write stream"), new Promise((i, n) => {
      const s = (o) => {
        var t;
        this.headers = [], o ? ((t = this.logger) == null || t.error(`Error during close: ${o}`), n(o)) : i();
      };
...
function $e(e, a, i) {
  ...
  function r(f, v, x) {
    ...
    return ca(f) ? !0 : (a.append(Ka(x, v, o), u(f)), !1);
  }
...
function Gi() {
  ...
  function e(a) {
    ...
    function n(p) {
      ...
      return x.namespace = p, x.useColors = n.useColors(), x.color = n.selectColor(p), x.extend = s, x.destroy = n.destroy, Object.defineProperty(x, "enabled", {
        enumerable: !0,
        configurable: !1,
        get: () => h !== null ? h : (f !== n.namespaces && (f = n.namespaces, v = n.enabled(p)), v),
        set: (g) => {
          h = g;
        }
    ...
    function s(p, m) {
      const h = n(this.namespace + (typeof m > "u" ? ":" : m) + p);
      return h.log = this.log, h;
    }
    function o(p) {
      n.save(p), n.namespaces = p, n.names = [], n.skips = [];
      let m;
      const h = (typeof p == "string" ? p : "").split(/[\s,]+/), f = h.length;
      for (m = 0; m < f; m++)
        h[m] && (p = h[m].replace(/\*/g, ".*?"), p[0] === "-" ? n.skips.push(new RegExp("^" + p.slice(1) + "$")) : n.names.push(new RegExp("^" + p + "$")));
    }
    function t() {
      const p = [
        ...n.names.map(d),
...
class si extends $.Transform {
  ...
  _transform(a, i, n) {
    const s = this[na], o = s.maxRate, t = this.readableHighWaterMark, c = s.timeWindow, d = 1e3 / c, u = o / d, r = s.minChunkSize !== !1 ? Math.max(s.minChunkSize, u * 0.01) : 0, p = (h, f) => {
      ...
      g && v > g && v - g > r && (x = h.subarray(g), h = h.subarray(0, g)), p(h, x ? () => {
    ...
    if (P.agent = He ? a.httpsAgent : a.httpAgent, a.transport ? Re = a.transport : a.maxRedirects === 0 ? Re = He ? _a : wa : (a.maxRedirects && (P.maxRedirects = a.maxRedirects), a.beforeRedirect && (P.beforeRedirects.config = a.beforeRedirect), Re = He ? rt : tt), a.maxBodyLength > -1 ? P.maxBodyLength = a.maxBodyLength : P.maxBodyLength = 1 / 0, a.insecureHTTPParser && (P.insecureHTTPParser = a.insecureHTTPParser), f = Re.request(P, function(_) {
      ...
      if (u === "stream")
        ...
        F.on("data", function(q) {
          D.push(q), Da += q.length, a.maxContentLength > -1 && Da > a.maxContentLength && (h = !0, F.destroy(), s(new b(
...
const sn = (e) => {
  ...
  return new Promise(function(i, n) {
    ...
    let { responseType: c, onUploadProgress: d, onDownloadProgress: u } = s, r, p, m, h, f;
    function v() {
    ...
    }, o === void 0 && t.setContentType(null), "setRequestHeader" in x && l.forEach(t.toJSON(), function(S, E) {
      x.setRequestHeader(E, S);
    }), l.isUndefined(s.withCredentials) || (x.withCredentials = !!s.withCredentials), c && c !== "json" && (x.responseType = s.responseType), u && ([m, f] = le(u, !0), x.addEventListener("progress", m)), d && x.upload && ([p, h] = le(d), x.upload.addEventListener("progress", p), x.upload.addEventListener("loadend", h)), (s.cancelToken || s.signal) && (r = (y) => {
      x && (n(!y || y.type ? new ee(null, e, x) : y), x.abort(), x = null);
...
const Et = async (e) => {
  ...
  let h = bt([s, o && o.toAbortSignal()], t), f;
  const v = h && h.unsubscribe && (() => {
    h.unsubscribe();
  });
  let x;
  try {
    if (d && kt && i !== "get" && i !== "head" && (x = await Rt(r, n)) !== 0) {
      let E = new Request(a, {
        method: "POST",
        body: n,
        duplex: "half"
...
let oa = [];
function qt(e, a) {
  return e.map((i) => (i = Bt(i, a), {
    ...i,
    price: (parseFloat(i.product_price) / 100).toFixed(2)
  }));
}
const Pt = {
