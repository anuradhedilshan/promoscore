...
var hn = (e, a, i) => a in e ? xn(e, a, { enumerable: !0, configurable: !0, writable: !0, value: i }) : e[a] = i;
var ae = (e, a, i) => hn(e, typeof a != "symbol" ? a + "" : a, i);
import { dialog as ka, app as Le, BrowserWindow as wi, ipcMain as Ue } from "electron";
import { fileURLToPath as vn } from "node:url";
import Y from "node:path";
import he from "fs";
import Ae from "path";
import we, { TextEncoder as bn } from "util";
import $, { Readable as gn } from "stream";
import _a from "http";
import Ea from "https";
import Ne from "url";
import yn from "assert";
import wn from "tty";
import kn from "os";
import Z from "zlib";
...
class jn {
  constructor(a, i, n) {
    ...
    const s = Ae.join(a, `.${i}`);
    this.writeStream = he.createWriteStream(s), this.writeStream.write(`{ "params": 
`), this.isOpen = !0, this.logger = n, (o = this.logger) == null || o.warn(`temp file created in ${this.writeStream.path}`);
  }
  writeHeader(a) {
    if (!this.isOpen)
      throw new Error("JSONWriter is closed. Cannot append data.");
    this.writeStream.write(`${a},
"data": [`);
  }
  appendData(a) {
    if (!this.isOpen)
...
const { toString: Sn } = Object.prototype, { getPrototypeOf: Ra } = Object, De = /* @__PURE__ */ ((e) => (a) => {
  const i = Sn.call(a);
...
const On = Ie("string"), N = Ie("function"), Ei = Ie("number"), $e = (e) => e !== null && typeof e == "object", Fn = (e) => e === !0 || e === !1, Oe = (e) => {
  if (De(e) !== "object")
    return !1;
  const a = Ra(e);
  return (a === null || a === Object.prototype || Object.getPrototypeOf(a) === null) && !(Symbol.toStringTag in e) && !(Symbol.iterator in e);
}, Ln = H("Date"), An = H("File"), zn = H("Blob"), qn = H("FileList"), Pn = (e) => $e(e) && N(e.pipe), Bn = (e) => {
  let a;
...
}, Un = H("URLSearchParams"), [Nn, Dn, In, $n] = ["ReadableStream", "Request", "Response", "Headers"].map(H), Mn = (e) => e.trim ? e.trim() : e.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
...
const ie = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : global, ji = (e) => !ve(e) && e !== ie;
function ca() {
  const { caseless: e } = ji(this) && this || {}, a = {}, i = (n, s) => {
    const o = e && Ri(a, s) || s;
...
const Hn = (e, a, i, { allOwnKeys: n } = {}) => (ke(a, (s, o) => {
  i && N(s) ? e[o] = ki(s, i) : e[o] = s;
}, { allOwnKeys: n }), e), Wn = (e) => (e.charCodeAt(0) === 65279 && (e = e.slice(1)), e), Vn = (e, a, i, n) => {
  ...
  for (; a-- > 0; )
    i[a] = e[a];
  return i;
}, Xn = /* @__PURE__ */ ((e) => (a) => e && a instanceof e)(typeof Uint8Array < "u" && Ra(Uint8Array)), Yn = (e, a) => {
  ...
  for (; (i = e.exec(a)) !== null; )
    n.push(i);
  return n;
}, Qn = H("HTMLFormElement"), es = (e) => e.toLowerCase().replace(
  /[-_\s]([a-z\d])(\w*)/g,
  function(i, n, s) {
    return n.toUpperCase() + s;
  }
), Ma = (({ hasOwnProperty: e }) => (a, i) => e.call(a, i))(Object.prototype), as = H("RegExp"), Si = (e, a) => {
...
}, os = (e, a) => e != null && Number.isFinite(e = +e) ? e : a, Ge = "abcdefghijklmnopqrstuvwxyz", Ha = "0123456789", Ci = {
  DIGIT: Ha,
  ALPHA: Ge,
  ALPHA_DIGIT: Ge + Ge.toUpperCase() + Ha
}, ts = (e = 16, a = Ci.ALPHA_DIGIT) => {
  let i = "";
  const { length: n } = a;
  for (; e--; )
    i += a[Math.random() * n | 0];
...
const cs = (e) => {
  ...
  return i(e, 0);
}, ps = H("AsyncFunction"), ls = (e) => e && ($e(e) || N(e)) && N(e.then) && N(e.catch), Ti = ((e, a) => e ? setImmediate : a ? ((i, n) => (ie.addEventListener("message", ({ source: s, data: o }) => {
  ...
  N(ie.postMessage)
), us = typeof queueMicrotask < "u" ? queueMicrotask.bind(ie) : typeof process < "u" && process.nextTick || Ti, p = {
  isArray: ue,
  isArrayBuffer: _i,
  isBuffer: Cn,
  isFormData: Bn,
...
Object.defineProperties(b, Fi);
Object.defineProperty(Oi, "isAxiosError", { value: !0 });
b.from = (e, a, i, n, s, o) => {
  const t = Object.create(Oi);
...
W.prototype.pipe = function() {
  var e = Ai.prototype.pipe.apply(this, arguments);
...
var fs = we, zi = $.Stream, Wa = ms, xs = S;
function S() {
...
S.prototype.pipe = function(e, a) {
  return zi.prototype.pipe.call(this, e, a), this.resume(), e;
};
 ...
 */
(function(e) {
  var a = vs, i = Ae.extname, n = /^\s*([^;\s]*)(?:;|\s|$)/, s = /^text\//i;
    ...
    Object.keys(a).forEach(function(f) {
      ...
      if (!(!x || !x.length)) {
        ...
        for (var g = 0; g < x.length; g++) {
          var w = x[g];
          if (l[w]) {
            var y = m.indexOf(a[l[w]].source), j = m.indexOf(v.source);
            if (l[w] !== "application/octet-stream" && (y > j || y === j && l[w].substr(0, 12) === "application/"))
              continue;
          }
          l[w] = f;
        }
...
var Bi = ws;
function ws(e) {
  Object.keys(e.jobs).forEach(ks.bind(e)), e.jobs = {};
}
function ks(e) {
  typeof this.jobs[e] == "function" && this.jobs[e]();
}
var Ja = Pi, _s = Bi, Ui = Es;
function Es(e, a, i, n) {
  var s = i.keyedList ? i.keyedList[i.index] : i.index;
  i.jobs[s] = Rs(a, s, e[s], function(o, t) {
    s in i.jobs && (delete i.jobs[s], o ? _s(i) : i.results[s] = t, n(o, i.results));
  });
}
function Rs(e, a, i, n) {
  var s;
...
var Ss = Bi, Cs = Pi, Di = Ts;
function Ts(e) {
  Object.keys(this.jobs).length && (this.index = this.size, Ss(this), Cs(e)(null, this.results));
}
var Os = Ui, Fs = Ni, Ls = Di, As = zs;
function zs(e, a, i) {
  for (var n = Fs(e); n.index < (n.keyedList || e).length; )
    Os(e, a, n, function(s, o) {
      if (s) {
        i(s, o);
        return;
      }
...
var Me = { exports: {} }, Ka = Ui, qs = Ni, Ps = Di;
Me.exports = Bs;
Me.exports.ascending = Ii;
Me.exports.descending = Us;
function Bs(e, a, i, n) {
  var s = qs(e, i);
...
var $i = Me.exports, Ns = $i, Ds = Is;
function Is(e, a, i) {
  return Ns(e, a, null, i);
}
var $s = {
  parallel: As,
  serial: Ds,
...
}, ja = xs, Mi = we, Xe = Ae, Hs = _a, Ws = Ea, Vs = Ne.parse, Js = he, Ks = $.Stream, Ye = qi, Gs = $s, pa = Ms, Xs = R;
Mi.inherits(R, ja);
function R(e) {
...
R.prototype.append = function(e, a, i) {
  ...
  if (typeof a == "number" && (a = "" + a), Mi.isArray(a)) {
...
R.prototype._trackLength = function(e, a, i) {
  var n = 0;
  i.knownLength != null ? n += +i.knownLength : Buffer.isBuffer(a) ? n = a.length : typeof a == "string" && (n = Buffer.byteLength(a)), this._valueLength += n, this._overheadLength += Buffer.byteLength(e) + R.LINE_BREAK.length, !(!a || !a.path && !(a.readable && a.hasOwnProperty("httpVersion")) && !(a instanceof Ks)) && (i.knownLength || this._valuesToMeasure.push(a));
};
R.prototype._lengthRetriever = function(e, a) {
  e.hasOwnProperty("fd") ? e.end != null && e.end != 1 / 0 && e.start != null ? a(null, e.end + 1 - (e.start ? e.start : 0)) : Js.stat(e.path, function(i, n) {
    var s;
    if (i) {
      a(i);
      return;
...
R.prototype.getLength = function(e) {
  ...
  Gs.parallel(this._valuesToMeasure, this._lengthRetriever, function(i, n) {
    if (i) {
      e(i);
      return;
    }
...
R.prototype.submit = function(e, a) {
  ...
  return typeof e == "string" ? (e = Vs(e), n = pa({
    ...
    host: e.hostname,
    protocol: e.protocol
  }, s)) : (n = pa(e, s), n.port || (n.port = n.protocol == "https:" ? 443 : 80)), n.headers = this.getHeaders(e.headers), n.protocol == "https:" ? i = Ws.request(n) : i = Hs.request(n), this.getLength((function(o, t) {
...
function Ga(e, a, i) {
  return e ? e.concat(a).map(function(s, o) {
    return s = Wi(s), !i && o ? "[" + s + "]" : s;
  }).join(i ? "." : "") : a;
}
function Ys(e) {
  return p.isArray(e) && !e.some(la);
}
const Zs = p.toFlatObject(p, {}, null, function(a) {
  return /^is[A-Z]/.test(a);
});
function He(e, a, i) {
  if (!p.isObject(e))
    throw new TypeError("target must be an object");
  a = a || new (Hi || FormData)(), i = p.toFlatObject(i, {
    metaTokens: !0,
    dots: !1,
    indexes: !1
  }, !1, function(v, x) {
  ...
  function r(f, v, x) {
    ...
    if (f && !x && typeof f == "object") {
      ...
      else if (p.isArray(f) && Ys(f) || (p.isFileList(f) || p.endsWith(v, "[]")) && (g = p.toArray(f)))
        return v = Wi(v), g.forEach(function(y, j) {
          !(p.isUndefined(y) || y === null) && a.append(
            // eslint-disable-next-line no-nested-ternary
            t === !0 ? Ga([v], j, o) : t === null ? v : v + "[]",
            u(y)
          );
        }), !1;
    }
...
function Sa(e, a, i) {
  if (!a)
    return e;
  const n = i && i.encode || Qs, s = i && i.serialize;
  let o;
...
}, Ta = typeof window < "u" && typeof document < "u", ua = typeof navigator == "object" && navigator || void 0, io = Ta && (!ua || ["ReactNative", "NativeScript", "NS"].indexOf(ua.product) < 0), no = typeof WorkerGlobalScope < "u" && // eslint-disable-next-line no-undef
self instanceof WorkerGlobalScope && typeof self.importScripts == "function", so = Ta && window.location.href || "http://localhost", oo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  hasBrowserEnv: Ta,
...
function Ki(e) {
  function a(i, n, s, o) {
    ...
    return t = !t && p.isArray(s) ? s.length : t, d ? (p.hasOwnProp(s, t) ? s[t] = [s[t], n] : s[t] = n, !c) : ((!s[t] || !p.isObject(s[t])) && (s[t] = []), a(i, n, s[t], o) && p.isArray(s[t]) && (s[t] = co(s[t])), !c);
  }
  ...
  transformRequest: [function(a, i) {
    ...
    if (o) {
      if (n.indexOf("application/x-www-form-urlencoded") > -1)
        return to(a, this.formSerializer).toString();
    ...
    return o || s ? (i.setContentType("application/json", !1), po(a)) : a;
  }],
...
const lo = p.toObjectSet([
  ...
  return e && e.split(`
`).forEach(function(t) {
    s = t.indexOf(":"), i = t.substring(0, s).trim().toLowerCase(), n = t.substring(s + 1).trim(), !(!i || a[i] && lo[i]) && (i === "set-cookie" ? a[i] ? a[i].push(n) : a[i] = [n] : a[i] = a[i] ? a[i] + ", " + n : n);
  }), a;
}, Za = Symbol("internals");
function me(e) {
...
class L {
  ...
  set(a, i, n) {
    ...
    if (p.isPlainObject(a) || a instanceof this.constructor)
      t(a, i);
    else if (p.isString(a) && (a = a.trim()) && !fo(a))
      t(uo(a), i);
...
function ko(e) {
  var a = typeof e == "string" ? go(e) : e || {}, i = a.protocol, n = a.host, s = a.port;
  if (typeof n != "string" || !n || typeof i != "string" || (i = i.split(":", 1)[0], n = n.replace(/:\d*$/, ""), s = parseInt(s) || yo[i] || 0, !_o(n, s)))
    return "";
...
function _o(e, a) {
  ...
  return i ? i === "*" ? !1 : i.split(/[,\s]/).every(function(n) {
    ...
    return t && t !== a ? !0 : /^[.*]/.test(o) ? (o.charAt(0) === "*" && (o = o.slice(1)), !wo.call(e, o)) : e !== o;
  }) : !0;
}
function pe(e) {
  return process.env[e.toLowerCase()] || process.env[e.toUpperCase()] || "";
}
var Eo = ko, Fa = { exports: {} }, Se = { exports: {} }, Ce = { exports: {} }, ea, Qa;
function Ro() {
  if (Qa) return ea;
  Qa = 1;
...
function Xi() {
  ...
  ei = 1;
  function e(a) {
    n.debug = n, n.default = n, n.coerce = u, n.disable = t, n.enable = o, n.enabled = c, n.humanize = Ro(), n.destroy = r, Object.keys(a).forEach((l) => {
      n[l] = a[l];
      ...
      function x(...g) {
        ...
        g[0] = g[0].replace(/%([a-zA-Z%])/g, (z, M) => {
          if (z === "%%")
            return "%";
          E++;
          const V = n.formatters[M];
          if (typeof V == "function") {
            const re = g[E];
            z = V.call(w, re), g.splice(E, 1), E--;
          }
          return z;
...
var oi;
function Oo() {
  return oi || (oi = 1, typeof process > "u" || process.type === "renderer" || process.browser === !0 || process.__nwjs ? Se.exports = jo() : Se.exports = To()), Se.exports;
}
var fe, Fo = function() {
  if (!fe) {
    try {
      fe = Oo()("follow-redirects");
    } catch {
    }
...
}, Ee = Ne, be = Ee.URL, Lo = _a, Ao = Ea, La = $.Writable, Aa = yn, Yi = Fo;
(function() {
...
B.prototype.destroy = function(e) {
  return Ua(this._currentRequest, e), Uo.call(this, e), this;
};
B.prototype.write = function(e, a, i) {
  ...
  this._requestBodyLength + e.length <= this._options.maxBodyLength ? (this._requestBodyLength += e.length, this._requestBodyBuffers.push({ data: e, encoding: a }), this._currentRequest.write(e, a, i)) : (this.emit("error", new Po()), this.abort());
};
...
B.prototype._processResponse = function(e) {
  ...
  var t = sa(/^host$/i, this._options.headers), c = Ba(this._currentUrl), d = t || c.host, u = /^\w+:/.test(i) ? this._currentUrl : Ee.format(Object.assign(c, { host: d })), r = No(i, u);
  if (Yi("redirecting to", r.href), this._isRedirect = !0, fa(r, this._options), (r.protocol !== c.protocol && r.protocol !== "https:" || r.host !== d && !Do(r.host, d)) && sa(/^(?:(?:proxy-)?authorization|cookie)$/i, this._options.headers), oe(s)) {
    var l = {
      headers: e.headers,
      statusCode: a
    }, m = {
...
function Zi(e) {
  ...
  return Object.keys(e).forEach(function(n) {
    ...
    function c(u, r, l) {
      return $o(u) ? u = fa(u) : ne(u) ? u = fa(Ba(u)) : (l = r, r = en(u), u = { protocol: s }), oe(r) && (l = r, r = null), r = Object.assign({
        maxRedirects: a.maxRedirects,
        maxBodyLength: a.maxBodyLength
      }, u, r), r.nativeProtocols = i, !ne(r.host) && !ne(r.hostname) && (r.hostname = "::1"), Aa.equal(r.protocol, s, "protocol mismatch"), Yi("options", r), new B(r, l);
    }
    function d(u, r, l) {
...
function Ba(e) {
  ...
  if (za)
    a = new be(e);
  else if (a = en(Ee.parse(e)), !ne(a.protocol))
...
Fa.exports = Zi({ http: Lo, https: Ao });
Fa.exports.wrap = Zi;
var Mo = Fa.exports;
const Ho = /* @__PURE__ */ Li(Mo), ze = "1.7.7";
function an(e) {
...
const Wo = /^(?:([^;]+);)?(?:[^;]+;)?(base64|),([\s\S]*)$/;
function Vo(e, a, i) {
  const n = i && i.Blob || O.classes.Blob, s = an(e);
...
const { asyncIterator: ri } = Symbol, nn = async function* (e) {
  e.stream ? yield* e.stream() : e.arrayBuffer ? yield await e.arrayBuffer() : e[ri] ? yield* e[ri]() : yield e;
}, Jo = p.ALPHABET.ALPHA_DIGIT + "-_", ge = new bn(), X = `\r
`, Ko = ge.encode(X), Go = 2;
class Xo {
  constructor(a, i) {
    ...
    s ? i = ge.encode(String(i).replace(/\r?\n|\r\n?/g, X)) : o += `Content-Type: ${i.type || "application/octet-stream"}${X}`, this.headers = ge.encode(o + X), this.contentLength = s ? i.byteLength : i.size, this.size = this.headers.byteLength + this.contentLength + Go, this.name = a, this.value = i;
  }
  async *encode() {
    yield this.headers;
    const { value: a } = this;
    p.isTypedArray(a) ? yield a : yield* nn(a), yield Ko;
  }
  static escapeName(a) {
...
const Yo = (e, a, i) => {
  const {
    ...
    size: s = 25,
    boundary: o = n + "-" + p.generateString(s, Jo)
  } = i || {};
  if (!p.isFormData(e))
  ...
  return Number.isFinite(d) && (r["Content-Length"] = d), a && a(r), gn.from(async function* () {
    for (const l of u)
      yield t, yield* l.encode();
    yield c;
  }());
};
class Zo extends $.Transform {
  __transform(a, i, n) {
    this.push(a), n();
  }
  _transform(a, i, n) {
...
const Qo = (e, a) => p.isAsyncFn(e) ? function(...i) {
  const n = i.pop();
...
}, pi = p.isFunction(Z.createBrotliDecompress), { http: nt, https: st } = Ho, ot = /https:?/, li = O.protocols.map((e) => e + ":"), ui = (e, [a, i]) => (e.on("end", i).on("error", i), a);
function tt(e, a) {
...
const rt = typeof process < "u" && p.kindOf(process) === "process", ct = (e) => new Promise((a, i) => {
  let n, s;
  const o = (d, u) => {
    s || (s = !0, n && n(d, u));
  }, t = (d) => {
...
}, di = (e, a) => pt(p.isObject(e) ? e : { address: e, family: a }), lt = rt && function(a) {
  return ct(async function(n, s, o) {
    let { data: t, lookup: c, family: d } = a;
    const { responseType: u, responseEncoding: r } = a, l = a.method.toUpperCase();
    let m, h = !1, f;
    if (c) {
      const _ = Qo(c, (k) => p.isArray(k) ? k : [k]);
      c = (k, A, ee) => {
        _(k, A, (F, K, Je) => {
          if (F)
            return ee(F);
    ...
    const w = Oa(a.baseURL, a.url), y = new URL(w, O.hasBrowserEnv ? O.origin : void 0), j = y.protocol || li[0];
    if (j === "data:") {
      let _;
      if (l !== "GET")
        return ce(n, s, {
    ...
    if (p.isSpecCompliantForm(t)) {
      ...
      t.size && E.setContentType(t.type || "application/octet-stream"), E.setContentLength(t.size || 0), t = $.Readable.from(nn(t));
    ...
    const fn = p.toFiniteNumber(E.getContentLength());
    p.isArray(M) ? (V = M[0], re = M[1]) : V = re = M, t && (U || V) && (p.isStream(t) || (t = $.Readable.from(t, { objectMode: !1 })), t = $.pipeline([t, new ti({
      maxRate: p.toFiniteNumber(V)
    ...
    !p.isUndefined(c) && (P.lookup = c), a.socketPath ? P.socketPath = a.socketPath : (P.hostname = y.hostname.startsWith("[") ? y.hostname.slice(1, -1) : y.hostname, P.port = y.port, sn(P, a.proxy, j + "//" + y.hostname + (y.port ? ":" + y.port : "") + P.path));
    let je;
    const Ve = ot.test(P.protocol);
    if (P.agent = Ve ? a.httpsAgent : a.httpAgent, a.transport ? je = a.transport : a.maxRedirects === 0 ? je = Ve ? Ea : _a : (a.maxRedirects && (P.maxRedirects = a.maxRedirects), a.beforeRedirect && (P.beforeRedirects.config = a.beforeRedirect), je = Ve ? st : nt), a.maxBodyLength > -1 ? P.maxBodyLength = a.maxBodyLength : P.maxBodyLength = 1 / 0, a.insecureHTTPParser && (P.insecureHTTPParser = a.insecureHTTPParser), f = je.request(P, function(k) {
      ...
      if (a.decompress !== !1 && k.headers["content-encoding"])
        switch ((l === "HEAD" || k.statusCode === 204) && delete k.headers["content-encoding"], (k.headers["content-encoding"] || "").toLowerCase()) {
          ...
          case "x-compress":
            ...
            break;
          case "deflate":
            A.push(new Zo()), A.push(Z.createUnzip(ci)), delete k.headers["content-encoding"];
            break;
          case "br":
            pi && (A.push(Z.createBrotliDecompress(it)), delete k.headers["content-encoding"]);
        }
...
const on = (e) => {
  ...
  if (O.hasStandardBrowserEnv && (n && p.isFunction(n) && (n = n(a)), n || n !== !1 && ut(a.url))) {
    const u = s && o && dt.read(o);
    u && t.set(s, u);
  }
  return a;
}, mt = typeof XMLHttpRequest < "u", ft = mt && function(e) {
  return new Promise(function(i, n) {
    ...
    }, o === void 0 && t.setContentType(null), "setRequestHeader" in x && p.forEach(t.toJSON(), function(j, E) {
...
}, vt = async function* (e, a) {
  for await (const i of bt(e))
    yield* ht(i, a);
}, bt = async function* (e) {
...
}, We = typeof fetch == "function" && typeof Request == "function" && typeof Response == "function", tn = We && typeof ReadableStream == "function", gt = We && (typeof TextEncoder == "function" ? /* @__PURE__ */ ((e) => (a) => e.encode(a))(new TextEncoder()) : async (e) => new Uint8Array(await new Response(e).arrayBuffer())), rn = (e, ...a) => {
  try {
    return !!e(...a);
  } catch {
    return !1;
  ...
  return e && !a;
}), xi = 64 * 1024, xa = tn && rn(() => p.isReadableStream(new Response("").body)), Be = {
  stream: xa && ((e) => e.body)
};
We && ((e) => {
...
const wt = async (e) => {
  ...
  let h = xt([s, o && o.toAbortSignal()], t), f;
  const v = h && h.unsubscribe && (() => {
    h.unsubscribe();
  });
  let x;
  try {
    if (d && yt && i !== "get" && i !== "head" && (x = await kt(r, n)) !== 0) {
      let E = new Request(a, {
        method: "POST",
        body: n,
        duplex: "half"
    ...
    u = u || "text";
    let j = await Be[p.findKey(Be, u) || "text"](w, e);
...
const hi = (e) => `- ${e}`, Et = (e) => p.isFunction(e) || e === null || e === !1, cn = {
  getAdapter: (e) => {
    e = p.isArray(e) ? e : [e];
    const { length: a } = e;
    let i, n;
    ...
    for (let o = 0; o < a; o++) {
      i = e[o];
      let t;
      if (n = i, !Et(i) && (n = ha[(t = String(i)).toLowerCase()], n === void 0))
...
function vi(e) {
  return ta(e), e.headers = L.from(e.headers), e.data = Qe.call(
    e,
    e.transformRequest
  ), ["post", "put", "patch"].indexOf(e.method) !== -1 && e.headers.setContentType("application/x-www-form-urlencoded", !1), cn.getAdapter(e.adapter || _e.adapter)(e).then(function(n) {
    ...
    return Gi(n) || (ta(e), n && n.response && (n.response.data = Qe.call(
      e,
      e.transformResponse,
      n.response
...
function pn(e) {
  const a = new se(e), i = ki(se.prototype.request, a);
...
T.mergeConfig = te;
T.AxiosHeaders = L;
T.formToJSON = (e) => Ki(p.isHTMLForm(e) ? new FormData(e) : e);
T.getAdapter = cn.getAdapter;
T.HttpStatusCode = ba;
T.default = T;
const Ct = {
  Accept: "*/*",
...
let C = null, ga = null;
function Ft(e) {
  return ga = e, C = new Ot(e), C;
}
function gi(e, a) {
  ga && ga(e, a);
}
async function ln(e, a) {
  C == null || C.log("searching _promoscore ....."), a || (a = e == "articles" ? Rn : En);
  const { data: i } = await Tt(a, e);
  return i;
}
let ra = [];
async function Lt(e, a, i) {
  ...
  s.writeHeader(JSON.stringify(i ? i[0].params : `${e}`));
  let o = 0, t = 1;
  i ? i[0].params.hitsPerPage = 10 : C == null || C.error("Body is Undefined");
  do
    try {
      C == null || C.log(`Fetching page ${o}`);
      const { results: c } = await ln(e, i), { hits: d, nbPages: u } = c[0];
      console.log("Nb Page", u), ra = ra.concat(d), t = u, C == null || C.log(`Fetching page ${o} Done Out of ${t}`), s.appendData(ra), o++;
      const r = (o / t * 100).toFixed(2);
      gi("progress", r), o == t - 1 && gi("complete", "done");
    } catch {
      C == null || C.error("Got Error in Main Loop");
    }
  while (o < t);
  return s.close(), {};
}
...
const un = Y.dirname(vn(import.meta.url));
process.env.APP_ROOT = Y.join(un, "..");
const ya = process.env.VITE_DEV_SERVER_URL, Zt = Y.join(process.env.APP_ROOT, "dist-electron"), dn = Y.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = ya ? Y.join(process.env.APP_ROOT, "public") : dn;
let I;
function mn() {
  I = new wi({
    width: 1e3,
...
const wa = Ft(ye), yi = (e) => e.toFixed(2), zt = (e) => Math.round(e * 100);
function qt(e, a) {
  const i = [
    {
      timestamp: "",
    ...
    if (e === "articles") {
      ...
      const o = s, t = parseFloat(o.product_price) / 100, c = zt(o.product_discount), d = parseFloat(o.product_unit_price) / 100;
      return {
        timestamp: "*",
        level: "table",
        message: `${o.article_name} | ${o.retailer} | ${yi(
          t
        )} lei | ${c}% | ${yi(d)} lei/${o.price_unit}`
      };
    }
  });
  return [...i, ...n];
...
Ue.handle(
  ...
  async (e, a, i) => {
    wa.log("Searching");
    const { results: n } = await ln(a, i);
    if (!n || n.length === 0)
      throw new Error("No results found");
    const { facets: s, nbHits: o, hits: t } = n[0];
    return o && ye("count", o), t && ye("data", qt(a, t)), s;
  }
);
...
Ue.on(
  ...
  async (e, a, i, n) => {
    ...
    try {
      xe || (xe = !0, await Lt(a, n, i), xe = !1, ye("complete", !0));
    } catch (s) {
      console.error(s), wa.error(`Data fetching failed : ${s}`), At.showDataFetchError(), ye("complete", !0), xe = !1;
    }
  }
);
export {
